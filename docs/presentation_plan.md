...
- **Sources & further reading:**
  - io_uring:
    - Jens Axboe (creator), "Efficient IO with io_uring" — https://kernel.dk/io_uring.pdf
    - "Lord of the io_uring" tutorial — https://unixism.net/loti/
    - Linux man page — https://www.man7.org/linux/man-pages/man7/io_uring.7.html
    - ScyllaDB blog — https://www.scylladb.com/2020/05/05/how-io_uring-and-ebpf-will-revolutionize-programming-in-linux/
    - ClickHouse real-world experience — https://clickhouse.com/blog/a-journey-to-io_uring-aio-and-modern-storage-devices
  - O_DIRECT, O_NOATIME, posix_fadvise:
    - open(2) man page — https://man7.org/linux/man-pages/man2/open.2.html
    - posix_fadvise(2) man page — https://www.man7.org/linux/man-pages/man2/posix_fadvise.2.html
    - ScyllaDB I/O access methods — https://www.scylladb.com/2017/10/05/io-access-methods-scylla/
  - Linux page cache & I/O data path:
    - Page cache theory (deep-dive) — https://biriukov.dev/docs/page-cache/2-essential-page-cache-theory/
    - Linux kernel block layer docs — https://docs.kernel.org/block/index.html
  - Syscall overhead:
    - "What makes syscalls expensive" — https://blog.codingconfessions.com/p/what-makes-system-calls-expensive
    - Context switch measurements — https://eli.thegreenplace.net/2018/measuring-context-switching-and-memory-overheads-for-linux-threads/
  - io_uring vs pread/pwrite benchmarks:
    - Academic comparison (2024) — https://arxiv.org/html/2512.04859v1
    - Sequential I/O benchmark — https://radiki.dev/posts/compare-sync-uring/
